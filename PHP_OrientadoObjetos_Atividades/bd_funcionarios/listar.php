...
<body>
    ...
    <div class="container mt-5">
        <a class="nav-link btn btn-primary btn-sm" href="contemMaria_ou_Joao.php" data-tooltip="tooltip" title="Página Inicial">Número de funcionários que contenham Maria ou João no nome</a>
    </div>
